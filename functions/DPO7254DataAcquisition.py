...
class DPO7254Visa():
    ...
    def saveData(self):
        ...
        np.savez_compressed(os.path.join(todaydatadir, nowformated), Ch_1_Data=self.wvfm[1],Ch_2_Data=self.wvfm[2],Ch_3_Data=self.wvfm[3],Ch_4_Data=self.wvfm[4],time=self.timeData, meta=meta)
